...
export class database1686174949071 implements MigrationInterface {
    name = 'database1686174949071'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "venta" ("id" integer NOT NULL, "id_user" integer NOT NULL, "estado" boolean NOT NULL, "name_cliente" character varying(80), "date" date NOT NULL, "total" double precision NOT NULL, CONSTRAINT "PK_8bb53d01fe72521d5cfb1f149d4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "producto" ("id" integer NOT NULL, "name" character varying NOT NULL, "codigo" character varying, "cantidad" integer NOT NULL, "categoryId" integer, CONSTRAINT "PK_5be023b11909fe103e24c740c7d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "category" ("id" SERIAL NOT NULL, "category" character varying NOT NULL, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" integer NOT NULL, "user" character varying(45) NOT NULL, "name" character varying NOT NULL, "password" character varying NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
